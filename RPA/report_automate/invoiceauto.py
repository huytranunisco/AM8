...
'''
def getInvoice(accBNP, facility, startP, endP, accName, dateName):
    try:  
        ...
        newPath = folderName + '//' + 'Invoice[' + newName + ']_' + dateName + '.xlsx'
...
for index in invoiceAccs.index:
    ...
    if invoiceAccs['BillingFreq'][index] == 'Bimonthly':
        ...
        getInvoice(bnpName, fac, startPeriod, endPeriod, accName, dateName)
        ...
        weeklyStartPeriods = find_sundays_between(previousBillDate, today)
